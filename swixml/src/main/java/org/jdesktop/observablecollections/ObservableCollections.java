...
public final class ObservableCollections
{
	...
	public static final class ObservableListHelper<E>
	{
		...
		/**
		 * Sends notification that the element at the specified index has
		 * changed.
		 *
		 * @param index the index of the element that has changed
		 * @throws ArrayIndexOutOfBoundsException if index is outside the range
		 *             of the {@code List} ({@code < 0 || >= size})
		 */
