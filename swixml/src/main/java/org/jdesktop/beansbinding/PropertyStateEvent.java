...
/**
 * An event characterizing a change in a {@code Property's} state for a
...
public class PropertyStateEvent extends EventObject
{
	...
	/**
	 * Creates an instance of {@code PropertyStateEvent} characterizing a change
	 * in a {@code Property's} state for a particular source object.
	 * <p>
	 * Note: To indicate a change in readability, specify {@code valueChanged}
	 * as {@code true} and reflect the readability status in the
	 * {@code oldValue} and {@code newValue} arguments.
	 *
	 * @param sourceProperty the {@code Property} whose state has changed
	 * @param sourceObject the source object for which the {@code Property's}
	 *            state has changed
	 * @param valueChanged whether or not the {@code Property's} value has
	 *            changed for the source object
	 * @param oldValue the old value of the {@code Property} for the source
	 *            object, or {@code UNREADABLE} if the {@code Property} was not
	 *            previously readable for the source object
	 * @param newValue the new value of the {@code Property} for the source
	 ...
	 *             {@code UNREADABLE}
	 */
	public PropertyStateEvent(Property<?, ?> sourceProperty, Object sourceObject, boolean valueChanged, Object oldValue,
	...
	/**
	 * Returns the {@code Property} whose state has changed. The preferred way
	 * to access this value is via the {@link #getSourceProperty} method.
	 *
	...
	/**
	 * Returns the source object for which the {@code Property's} state has
	 * changed.
	 *
	 * @return the source object for which the {@code Property's} state has
	 *         changed
	 */
	...
	/**
	 * Returns whether or not the {@code Property's} value has changed for the
	 * source object.
	 *
	 * @return whether or not the {@code Property's} value has changed for the
	 *         source object.
	 */
	...
	/**
	 * Returns the old value of the {@code Property} for the source object, or
	 * {@code UNREADABLE} if the {@code Property} was not previously readable
	 * for the source object.
	 * <p>
	 * Note: This method must only be called if {@code getValueChanged} returns
	 * {@code true}.
	 *
	 * @return the old value of the {@code Property} for the source object or
	 *         {@code UNREADABLE}
	...
	/**
	 * Returns the new value of the {@code Property} for the source object, or
	 * {@code UNREADABLE} if the {@code Property} is not currently readable for
	 * the source object.
	 * <p>
	 * Note: This method must only be called if {@code getValueChanged} returns
	 * {@code true}.
	 *
	 * @return the new value of the {@code Property} for the source object or
	 *         {@code UNREADABLE}
	 * @throws UnsupportedOperationException if the value hasn't changed
	 */
	...
	/**
	 * Returns whether or not the {@code Property} is currently readable for the
	 * source object. In particular, this returns {@code true} if and only if
	 * the new value is not {@code UNREADABLE}.
	 * <p>
	 * Note: This method must only be called if {@code getReadableChanged}
	 * returns {@code true}.
	 *
	 * @return whether or not the {@code Property} is currently readable for the
	 *         source object.
	...
	public String toString()
	{
		...
		buffer.append(": Property ").append(getSourceProperty()).append(" changed on ").append(getSourceObject())
			.append(":\n");
		if ( getValueChanged() )
		{
			buffer.append("    value changed from ").append(getOldValue()).append(" to ").append(getNewValue())
				.append('\n');
		}
		if ( getReadableChanged() )
		{
			buffer.append("    readable changed from ").append(!isReadable()).append(" to ").append(isReadable())
				.append('\n');
		}
