...
public abstract class Validator<T>
{
	 ...
	 * <p>
	 * A {@code Result} can contain an error code and/or description. These
	 * values are for your own reporting purposes and are not used internally.
	 */
	public class Result
	{
		 ...
		 *
		 * @param errorCode an error code for this {@code Result}, may be
		 *            {@code null}
		 * @param description a textual description of the {@code Result}, may
		 *            be {@code null}
		 */
		...
		{
			return getClass().getName() + " [" + "errorCode=" + errorCode + ", description=" + description + "]";
		}
	}
