...
/**
 * {@code Binding} is an abstract class that represents the concept of a binding
 * between two properties, typically of two objects, and contains methods for
 * explicitly synchronizing the values of the two properties. {@code Binding}
 * itself does no automatic synchronizing between property values. Subclasses
 * will typically keep the values in sync according to some strategy.
 * 
 * <p>Some {@code Bindings} are managed, often by another {@code Binding}. A
 * managed {@code Binding} does not allow certain methods to be called by the
 * user. These methods are identified in their documentation. Subclasses should
 * call {@code setManaged(true)} to make themselves managed. {@code Binding}
 * provides protected versions of the managed methods with the suffix
 * {@code "Unmanaged"} for subclasses to use internally without checking whether
 * or not they are managed.</p>
 *
 * <p>Any {@code PropertyResolutionExceptions} thrown by {@code Property} objects
 * used by this binding are allowed to flow through to the caller of the
 * {@code Binding} methods.</p>
 *
 * @author Shannon Hickey
 *
 * @see <a href="file:package-info.java">LICENSE: package-info</a>
 * 
 * @apiNote {@code <SS>} the type of source object
 * @apiNote {@code <SV>} the type of value that the source property represents
 * @apiNote {@code <TS>} the type of target object
 * @apiNote {@code <TV>} the type of value that the target property represents
 */
public abstract class Binding<SS, SV, TS, TV>
{
	...
	/**
	 * An enumeration representing the reasons a sync ({@code save} or
	 * {@code refresh}) can fail on a {@code Binding}.
	 *
	 * @see Binding#refresh
	 * @see Binding#save
	 */
	public enum SyncFailureType
	{
		...
		SOURCE_UNWRITEABLE,
		/**
		 * A {@code save} failed because the {@code Binding's} target property
		 * is unreadable for the {@code Binding's} target object.
		 */
		TARGET_UNREADABLE,
		/**
		 * A {@code refresh} failed because the {@code Binding's} source
		 * property is unreadable for the {@code Binding's} source object.
		 */
		SOURCE_UNREADABLE,
		/**
		 * A {@code save} failed due to a conversion failure on the value
		 * returned by the {@code Binding's} target property for the
		 * {@code Binding's} target object.
		 */
		CONVERSION_FAILED,
		/**
	...
	/**
	 * {@code SyncFailure} represents a failure to sync ({@code save} or
	 * {@code refresh}) a {@code Binding}.
	 */
	public static final class SyncFailure
	{
		...
		/**
		 * Returns the exception that occurred during conversion if this failure
		 * represents a conversion failure. Throws
		 * {@code UnsupportedOperationException} otherwise.
		 *
		 * @return the exception that occurred during conversion
		 * @throws UnsupportedOperationException if the type of failure is not
		...
		/**
		 * Returns the result that was returned from the {@code Binding's}
		 * validator if this failure represents a validation failure. Throws
		 * {@code UnsupportedOperationException} otherwise.
		 *
		 * @return the result that was returned from the {@code Binding's}
		 *         validator
		 * @throws UnsupportedOperationException if the type of failure is not
		 *             {@code SyncFailureType.VALIDATION_FAILED}
		 */
	...
	public static final class ValueResult<V>
	{
		...
		/**
		 * Returns {@code true} if this {@code ValueResult} represents a failure
		 * and {@code false} otherwise.
		 *
		 * @return {@code true} if this {@code ValueResult} represents a failure
		 *         and {@code false} otherwise
		 * @see #getFailure
		 */
		...
		/**
		 * Returns the resulting value if this {@code ValueResult} does not
		 * represent a failure and throws {@code UnsupportedOperationException}
		 * otherwise.
		 *
		 * @return the resulting value
		 * @throws UnsupportedOperationException if this {@code ValueResult}
		...
		/**
		 * Returns the failure if this {@code ValueResult} represents a failure
		 * and throws {@code UnsupportedOperationException} otherwise.
		 *
		 * @return the failure
		 * @throws UnsupportedOperationException if this {@code ValueResult}
	 ...
	 */
	protected Binding(SS sourceObject, Property<SS, SV> sourceProperty, TS targetObject,
	 ...
	 * {@code "sourceProperty"} when the value of this property changes.
	 * <p>
	 ...
	 * <p>
	 * {@code Binding} fires a property change notification with property name
	 * {@code "targetProperty"} when the value of this property changes.
	 * <p>
	 * This method may not be called on a bound binding.
	 *
	...
	/**
	 * Returns the {@code Binding's} source property, which may not be
	 * {@code null}.
	 *
	...
	/**
	 * Returns the {@code Binding's} target property, which may not be
	 * {@code null}.
	 *
	 ...
	 * <p>
	 * {@code Binding} fires a property change notification with property name
	 * {@code "sourceObject"} when the value of this property changes.
	 * <p>
	 ...
	 * subclasses to set the source object without throwing an exception for
	 * being managed.
	 *
	 * @param sourceObject the source object, or {@code null}
	 * @throws IllegalStateException if the {@code Binding} is bound
	 ...
	 * <p>
	 * {@code Binding} fires a property change notification with property name
	 * {@code "targetObject"} when the value of this property changes.
	 * <p>
	 * This method may not be called on a managed or bound binding.
	 *
	 ...
	 * subclasses to set the target object without throwing an exception for
	 * being managed.
	 *
	 * @param targetObject the target object, or {@code null}
	 * @throws IllegalStateException if the {@code Binding} is bound
	 ...
	 * <p>
	 * {@code Binding} fires a property change notification with property name
	 * {@code "validator"} when the value of this property changes.
	 * <p>
	 * This method may not be called on a bound binding.
	 * <p>
	 * See the documentation on {@link #getTargetValueForSource} for details on
	 * how a {@code Binding's Validator} is used.
	 *
	...
	/**
	 * Sets the {@code Converter} for the {@code Binding}, which may be
	 * {@code null}.
	 * <p>
	 * {@code Binding} fires a property change notification with property name
	 * {@code "converter"} when the value of this property changes.
	 * <p>
	 * This method may not be called on a bound binding.
	 * <p>
	 * See the documentation on {@link #getTargetValueForSource} and
	 * {@link #getSourceValueForTarget} for details on how a
	 * {@code Binding's Converter} is used.
	 *
	 ...
	 * <p>
	 * {@code Binding} fires a property change notification with property name
	 * {@code "sourceNullValue"} when the value of this property changes.
	 * <p>
	 * This method may not be called on a bound binding.
	 *
	 ...
	 * <p>
	 * {@code Binding} fires a property change notification with property name
	 * {@code "targetNullValue"} when the value of this property changes.
	 * <p>
	 * This method may not be called on a bound binding.
	 *
	 ...
	 * method stores the given value and indicates that
	 ...
	 * {@code false}.
	 * <p>
	 * Setting this property to {@code null} acts the same as setting it to any
	 * other value. To return the property to the unset state (clearing the
	 * value and setting {@code sourceUnreadableValueSet} back to {@code false})
	 * call {@link #unsetSourceUnreadableValue}.
	 * <p>
	 * If this property was previously unset, this method fires a property
	 * change notification with property name
	 * {@code "sourceUnreadableValueSet"}. For all invocations, it also fires a
	 * property change notification with property name
	 * {@code "sourceUnreadableValue"}, if necessary, to indicate a change in
	 * the property value. If previously unset, the event will indicate an old
	 * value of {@code null}.
	 * <p>
	 * This method may not be called on a bound binding.
	 *
	...
	/**
	 * Unsets the value of the {@code sourceUnreadableValue} property by
	 * clearing the value and setting the value of the
	 ...
	 * The event for the latter notification will have a new value of
	 * {@code null}.
	 * <p>
	...
	/**
	 * Returns the value of the {@code sourceUnreadableValueSet} property, which
	 * indicates whether or not the {@code sourceUnreadableValue} property is
	 * set on the {@code Binding}.
	 * <p>
	 * See the documentation for {@link #setSourceUnreadableValue} for more
	 * information on the {@code sourceUnreadableValue} property.
	 *
	 * @return whether or not the {@code sourceUnreadableValue} property is set
	 *         on the {@code Binding}
	...
	/**
	 * Adds a {@code BindingListener} to be notified of changes to this
	 * {@code Binding}. Does nothing if the listener is {@code null}. If a
	 * listener is added more than once, notifications are sent to that listener
	 * once for every time that it has been added. The ordering of listener
	...
	/**
	 * Removes a {@code BindingListener} from the {@code Binding}. Does nothing
	 * if the listener is {@code null} or is not one of those registered. If the
	 ...
	 * no listeners.
	 *
	 * @return the list of {@code BindingListeners} registered on this
	 *         {@code Binding}
	 * @see #addBindingListener
	 */
	 ...
	 * {@link #isSourceUnreadableValueSet} is checked. If {@code true} then a
	 * {@code ValueResult} is returned containing the value of the
	 * {@code Binding's} {@link #getSourceUnreadableValue}. Otherwise a
	 * {@code ValueResult} is returned representing a failure with failure type
	 * {@code SyncFailureType.SOURCE_UNREADABLE}.
	 * <p>
	 * Next, the value of the source property is fetched for the source object.
	 * If the value is {@code null}, a {@code ValueResult} is returned
	 * containing the value of the {@code Binding's}
	 * {@link #getSourceNullValue}. If the value is {@code non-null}, the
	 * {@code Binding's Converter}, if any, is run to convert the value from
	 * source type to the target property's {@code getWriteType}, by calling its
	 * {@code convertForward} method with the value. If no {@code Converter} is
	 * registered, a set of default converters is checked to see if one of them
	 * can convert the value to the target type. Finally, the value (converted
	 * or not) is cast to the target write type.
	 * <p>
	 ...
	 * representing a failure with failure type
	 * {@code SyncFailureType.TARGET_UNREADABLE}.
	 * <p>
	 * Next, the value of the target property is fetched for the target object.
	 * If the value is {@code null}, a {@code ValueResult} is returned
	 * containing the value of the {@code Binding's}
	 * {@link #getTargetNullValue}. If the value is {@code non-null}, the
	 * {@code Binding's Converter}, if any, is run to convert the value from
	 * target type to the source property's {@code getWriteType}, by calling its
	 * {@code convertReverse} method with the value. If no {@code Converter} is
	 * registered, a set of default converters is checked to see if one of them
	 * can convert the value to the source type. Finally, the value (converted
	 * or not) is cast to the source write type.
	 * <p>
	 * If a converter throws a {@code RuntimeException} other than
	 * {@code ClassCastException}, this method returns a {@code ValueResult}
	 * containing the failure, with failure type
	 * {@code SyncFailureType.CONVERSION_FAILURE}.
	 * <p>
	 * As the last step, the {@code Binding's Validator}, if any, is called upon
	 * to validate the final value. If the {@code Validator} returns
	 * {@code non-null} from its {@code validate} method, a {@code ValueResult}
	 * is returned containing the validation result, with failure type
	 * {@code SyncFailureType.VALIDATION_FAILURE}. Otherwise a
	...
	/**
	 * Binds this binding. Calls {@link #bindImpl} to allow subclasses to
	 * initiate binding, adds a {@code PropertyStateListener} to the source
	 ...
	 * {@code BindingListeners} that the binding has become bound, and fires a
	 * property change notification to indicate a change to the {@code "bound"}
	 * property.
	 *
	 * @throws UnsupportedOperationException if the {@code Binding} is managed
	...
	/**
	 * A protected version of {@link #bind} that allows managed subclasses to
	 * bind without throwing an exception for being managed.
	 *
	 * @throws IllegalStateException if the {@code Binding} is bound
	 * @see #isManaged()
	 * @see #isBound()
	 ...
	 * Subclasses typically need not install {@code PropertyStateListeners} on
	 * the source property and target property as they will be notified by calls
	 * to {@link #sourceChangedImpl} and {@link #targetChangedImpl} when the
	 * source and target properties change respectively.
	 *
	 * @see #unbindImpl
	 */
	...
	/**
	 * A protected version of {@link #unbind} that allows managed subclasses to
	 * unbind without throwing an exception for being managed.
	 *
	 * @throws IllegalStateException if the {@code Binding} is not bound
	 * @see #isManaged()
	 * @see #isBound()
	 ...
	 * <p>
	 * {@code Binding} fires a property change notification with property name
	 * {@code "bound"} when the value of this property changes.
	 *
	 ...
	 * {@code Bindings} are managed, often by another {@code Binding}. A managed
	 * {@code Binding} does not allow certain methods to be called by the user.
	 * These methods are identified in their documentation. Subclasses should
	 * call {@code setManaged(true)} to make themselves managed. {@code Binding}
	 * provides protected versions of the managed methods, with the suffix
	 * {@code "Unmanaged"}, for subclasses to use internally without checking
	...
	/**
	 * Notifies all registered {@code BindingListeners} of a successful sync
	 * ({@code refresh} or {@code save}), by calling {@code synced} on each one.
	 */
	...
	/**
	 * Notifies all registered {@code BindingListeners} of a failure to sync
	 * ({@code refresh} or {@code save}), by calling {@code syncFailed} on each
	 * one.
	 *
	...
	/**
	 * The same as {@link #refresh} with the additional behavior of notifying
	 * all registered {@code BindingListeners} with {@code synced} if
	 * {@code refresh} returns {@code null} or {@code syncFailed} if
	 * {@code refresh} returns a {@code SyncFailure}.
	 *
	 ...
	 * subclasses to refresh and notify without throwing an exception for being
	 * managed.
	 *
	 * @return the return value from the call to {@code refresh}
	 * @throws RuntimeException as specified by {@link #refresh}
	...
	/**
	 * The same as {@link #save} with the additional behavior of notifying all
	 * registered {@code BindingListeners} with {@code synced} if {@code save}
	 * returns {@code null} or {@code syncFailed} if {@code save} returns a
	 * {@code SyncFailure}.
	 *
	 ...
	 * subclasses to save and notify without throwing an exception for being
	 * managed.
	 *
	 * @return the return value from the call to {@code save}
	 ...
	 * it as the value of the target property for the target object. First calls
	 * {@link #getSourceValueForTarget}. If the return value from that method
	 * represents a failure, this method returns the failure. Otherwise, it
	 * calls {@code setValue} on the target property for the target object with
	 * the value obtained from the source.
	 *
	 ...
	 * it as the value of the source property for the source object. First calls
	 * {@link #getTargetValueForSource}. If the return value from that method
	 * represents a failure, this method returns the failure. Otherwise, it
	 * calls {@code setValue} on the source property for the source object with
	 * the value obtained from the target.
	 *
	 * @return the reason for failure if the binding could not be saved, or
	 *         {@code null} for success
	 * @throws UnsupportedOperationException if the {@code Binding} is managed
	...
	/**
	 * A protected version of {@link #save} that allows managed subclasses to
	 * save without throwing an exception for being managed.
	 *
	 * @return the reason for failure if the binding could not be saved, or
	 *         {@code null} for success
	 * @throws ClassCastException if thrown by {@link #getTargetValueForSource}
	...
	/**
	 * Throws an UnsupportedOperationException if the {@code Binding} is
	 * managed. Useful for calling at the beginning of method implementations
	 * that shouldn't be called on managed {@code Bindings}
	 *
	 * @throws UnsupportedOperationException if the {@code Binding} is managed
	 * @see #isManaged()
	 */
	...
	/**
	 * Throws an IllegalStateException if the {@code Binding} is bound. Useful
	 * for calling at the beginning of method implementations that shouldn't be
	 * called when the {@code Binding} is bound.
	 *
	 * @throws IllegalStateException if the {@code Binding} is bound.
	 */
	...
	/**
	 * Throws an IllegalStateException if the {@code Binding} is unbound. Useful
	 * for calling at the beginning of method implementations that should only
	 * be called when the {@code Binding} is bound.
	 *
	...
	/**
	 * Returns a string representation of the {@code Binding}. This method is
	...
	{
		return "name="	+ getName() + ", sourceObject=" + sourceObject + ", sourceProperty=" + sourceProperty
				+ ", targetObject=" + targetObject + ", targetProperty=" + targetProperty + ", validator=" + validator
				+ ", converter=" + converter + ", sourceNullValue=" + sourceNullValue + ", targetNullValue="
				+ targetNullValue + ", sourceUnreadableValueSet=" + sourceUnreadableValueSet
				+ ", sourceUnreadableValue=" + sourceUnreadableValue + ", bound=" + isBound;
	}
	 ...
	 * {@code PropertyStateEvent} to indicate that its state has changed for the
	 * source object. Called after the {@code Binding} has notified any property
	 * change listeners and {@code BindingListeners} that the source value has
	 * been edited (only if the {@code PropertyStateEvent} represents a value
	 * change). This method is useful for subclasses to detect source changes
	 * and perform syncing as appropriate.
	 */
	 ...
	 * {@code PropertyStateEvent} to indicate that its state has changed for the
	 * target object. Called after the {@code Binding} has notified any property
	 * change listeners and {@code BindingListeners} that the target value has
	 * been edited (only if the {@code PropertyStateEvent} represents a value
	 * change). This method is useful for subclasses to detect target changes
	 * and perform syncing as appropriate.
	 */
	 ...
	 * sent to that listener once for every time that it has been added. The
	 * ordering of listener notification is unspecified.
	 * 
	 * <p>{@code Binding} fires property change notification for the following
	 * properties:</p>
	 * 
	 * <ul>
	 * <li>{@code sourceProperty}</li>
	 * <li>{@code targetProperty}</li>
	 * <li>{@code sourceObject}</li>
	 * <li>{@code targetObject}</li>
	 * <li>{@code validator}</li>
	 * <li>{@code converter}</li>
	 * <li>{@code sourceNullValue}</li>
	 * <li>{@code targetNullValue}</li>
	 * <li>{@code sourceUnreadableValueSet}</li>
	 * <li>{@code sourceUnreadableValue}</li>
	 * <li>{@code bound}
	 * </ul>
	 * 
	 * <p>For other types of {@code Binding} notifications register a
	 * {@code BindingListener}.</p>
	 *
	 * @param listener the listener to add
	 * @see #addBindingListener
	 */
	...
	/**
	 * Adds a {@code PropertyChangeListener} to be notified when the property
	 * identified by the {@code propertyName} argument changes on this
	 * {@code Binding}. Does nothing if the property name or listener is
	 * {@code null}. If a listener is added more than once, notifications are
	 * sent to that listener once for every time that it has been added. The
	 * ordering of listener notification is unspecified.
	 * 
	 ...
	 * nothing if the listener is {@code null} or is not one of those
	 * registered. If the listener being removed was registered more than once,
	 * only one occurrence of the listener is removed from the list of
	...
	/**
	 * Removes a {@code PropertyChangeListener} from the {@code Binding} for the
	 * given property name. Does nothing if the property name or listener is
	 * {@code null} or the listener is not one of those registered. If the
	 * listener being removed was registered more than once, only one occurrence
	 * of the listener is removed from the list of listeners. The ordering of
	 * listener notification is unspecified.
	 * 
	 ...
	 * no listeners.
	 *
	 * @return the list of {@code PropertyChangeListeners} registered on this
	 *         {@code Binding}
	 * @see #addPropertyChangeListener
	 */
	...
	/**
	 * Returns the list of {@code PropertyChangeListeners} registered on this
	 * {@code Binding} for the given property name. Order is undefined. Returns
	 * an empty array if there are no listeners registered for the property
	 * name.
	 *
	 * @param propertyName the property name to retrieve the listeners for
	 * @return the list of {@code PropertyChangeListeners} registered on this
	 *         {@code Binding} for the given property name
	 * @see #addPropertyChangeListener(String, PropertyChangeListener)
	 */
	...
	/**
	 * Sends a {@code PropertyChangeEvent} to the
	 * {@code PropertyChangeListeners} registered on the {@code Binding}.
	 *
	...
	private class PSL implements PropertyStateListener
	{
		...
		public void propertyStateChanged(PropertyStateEvent pse)
		{
			...
			if
			(
				pse.getSourceProperty() == sourceProperty &&
