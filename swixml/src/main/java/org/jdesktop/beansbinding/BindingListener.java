...
public interface BindingListener extends EventListener
{
	...
	/**
	 * Notification that the source and target of a {@code Binding} have been
	 * made in sync.
	 *
	 * @param binding the {@code Binding}
	 */
	 ...
	 * {@code PropertyStateEvent} for the {@code Binding's} source object.
	 *
	 * @param binding the {@code Binding}
	 */
	 ...
	 * {@code PropertyStateEvent} for the {@code Binding's} target object.
	 *
	 * @param binding the {@code Binding}
	 */
