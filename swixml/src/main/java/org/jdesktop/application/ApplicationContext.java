 ...
 * Framework API can be accessed through {@code
...
{
	protected static final Logger logger = LoggerFactory.getLogger(ApplicationContext.class);
	 ...
	 * @see #getApplication
	 */
	public final synchronized Class<? extends Application> getApplicationClass()
	{
	 ...
	 */
	public final synchronized void setApplicationClass(Class<? extends Application> applicationClass)
	{
