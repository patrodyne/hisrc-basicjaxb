 ...
 * and the source of all TaskEvents is the Task object.
 * 
...
public interface TaskListener<T, V>
{
	 ...
	 * {@code get} method, i.e. the value that is computed by
	 ...
	 * called. The {@code event's} source is the Task and its value is null.
	 *
	 * @param event a TaskEvent whose source is the {@code Task} object, value
	 *            is null
	 * @see Task#cancelled
