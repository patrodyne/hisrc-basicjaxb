 ...
 * {@code startup}, create the GUI's main panel, and apply {@code show} to that.
 * Here's an example:
 * 
 * <pre>
 * class MyApplication
...
public abstract class SingleFrameApplication extends Application
{
	...
	protected static final Logger logger = LoggerFactory.getLogger(SingleFrameApplication.class);
