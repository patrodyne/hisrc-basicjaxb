...
public class MergeablePlugin extends AbstractParameterizablePlugin {
	...
	private Ignoring ignoring = new CustomizedIgnoring(
			org.jvnet.basicjaxb.plugin.mergeable.Customizations.IGNORED_ELEMENT_NAME,
	...
	public Collection<QName> getCustomizationElementNames() {
		return Arrays
				.asList(org.jvnet.basicjaxb.plugin.mergeable.Customizations.IGNORED_ELEMENT_NAME,
						Customizations.IGNORED_ELEMENT_NAME,
						Customizations.GENERATED_ELEMENT_NAME);
	}
