...
public class ToStringPlugin extends AbstractParameterizablePlugin {
	...
	private Ignoring ignoring = new CustomizedIgnoring(
			org.jvnet.basicjaxb.plugin.tostring.Customizations.IGNORED_ELEMENT_NAME,
	...
	public Collection<QName> getCustomizationElementNames() {
		return Arrays
				.asList(org.jvnet.basicjaxb.plugin.tostring.Customizations.IGNORED_ELEMENT_NAME,
						Customizations.IGNORED_ELEMENT_NAME,
						Customizations.GENERATED_ELEMENT_NAME);
	}
	...
	protected JMethod generateObject$toString(final ClassOutline classOutline, final JDefinedClass theClass)
	{
		...
		object$toString.annotate(Override.class);
		{
			...
			(
				JMod.FINAL, codeModel.ref(ToStringStrategy.class),	"strategy",
