...
/**
 * Concrete extension of {@link AbstractCodeGenerator} for {@link Byte} types.
 *
 * @param <A> The generic type of the plugin arguments.
 */
public class ByteCodeGenerator<A extends Arguments<A>> extends AbstractCodeGenerator<A>
{
	/**
	 ...
	 */
	public ByteCodeGenerator(CodeGenerator<A> codeGenerator, CodeGenerationImplementor<A> implementor)
	{
	 ...
	 * Delegates to the {@link CodeGenerationImplementor}'s <em>onByte()</em> method.
	 */
	@Override
