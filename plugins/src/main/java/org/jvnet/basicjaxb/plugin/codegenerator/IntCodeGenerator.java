...
/**
 * Concrete extension of {@link AbstractCodeGenerator} for {@link Integer} types.
 *
 * @param <A> The generic type of the plugin arguments.
 */
public class IntCodeGenerator<A extends Arguments<A>> extends AbstractCodeGenerator<A>
{
	/**
	 ...
	 */
	public IntCodeGenerator(CodeGenerator<A> codeGenerator, CodeGenerationImplementor<A> implementor)
	{
	 ...
	 * Delegates to the {@link CodeGenerationImplementor}'s <em>onInt()</em> method.
	 */
	@Override
