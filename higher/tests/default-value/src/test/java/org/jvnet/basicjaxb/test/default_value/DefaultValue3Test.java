...
@Order(2)
public class DefaultValue3Test extends AbstractDefaultValueTest
{
	...
	@Test
	public void testDefaultValue3AB() throws Exception
	{
		String doc3A = marshalToString(document3A);
		getLogger().debug("doc3A: {}\n", doc3A);

		String doc3B = marshalToString(document3B);
		getLogger().debug("doc3B: {}\n", doc3B);
		
		// document3A: All attributes and elements have set values, see document3.xml.
