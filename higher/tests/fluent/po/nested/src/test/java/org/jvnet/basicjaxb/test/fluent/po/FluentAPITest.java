		...
		if ( object instanceof PurchaseOrder )
		{
			...
			PurchaseOrder po2 = OF.createPurchaseOrder()
				...
				.usePayments(OF.createPurchaseOrderPayments()
					.usePayment(
						OF.createPurchaseOrderPaymentsPayment().usePaymentDate(LocalDate.parse("1999-10-21")).useValue(toBigDecimal("5.00")),
						OF.createPurchaseOrderPaymentsPayment().usePaymentDate(LocalDate.parse("1999-10-22")).useValue(toBigDecimal("10.00")),
						OF.createPurchaseOrderPaymentsPayment().usePaymentDate(LocalDate.parse("1999-10-23")).useValue(toBigDecimal("24.98"))
					)
				)
				.useCredits
				(
