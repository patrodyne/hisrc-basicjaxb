package org.patrodyne.jvnet.basicjaxb.ex001;
...
import org.patrodyne.jvnet.basicjaxb.ex001.model.Person;
...
{
	private static final String WINDOW_TITLE = "HiSrc BasicJAXB Ex001 EqualsStrategy";
	...
	public void compareToString()
	{
		...
		println("Person1 toString: " + getPerson1().toString());
		println("Person2 toString: " + getPerson2().toString());
		println("Person3 toString: " + getPerson3().toString());
		println();
	}
	...
	private void initializeExplorer() throws Exception
	{
		...
		setPerson1(createPerson("Arthur", "Dent"));
		setPerson2(createPerson("Arthur", "Dent"));
		setPerson3(createPerson("Ford", "Prefect"));
	}
